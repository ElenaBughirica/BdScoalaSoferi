...
public class r2 extends javax.swing.JFrame {
    ...
    try {
          ...
          //  System.out.println(nume);
             ResultSet rs=cm.exQuery("select m.Numar,m.Marca,sum(im.OreSaptamana) as NrOre" +
            ...
            while(rs.next()) {
                model.insertRow(model.getRowCount(),new Object[]{rs.getString("numar"),rs.getString("marca"),rs.getString("nrore")} );
